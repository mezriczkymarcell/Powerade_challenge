    ...
    <Card className="relative overflow-hidden p-4"
      ...
      {!empty && (
        <svg className="pointer-events-none absolute inset-0 h-full w-full opacity-20" viewBox="0 0 400 120" preserveAspectRatio="none">
          {Array.from({ length: 9 }).map((_, i) => (
            <path key={i} d={`M60 60 L400 ${-40 + i * 30} L400 ${-20 + i * 30} Z`} fill="#FFD466" opacity="0.35" />
          ))}
        </svg>
      )}
      ...
      <div className="relative flex items-center gap-3">
        ...
        <button onClick={drink} className="shrink-0 select-none"
          ...
          <svg width="86" height="112" viewBox="0 0 120 150">
            ...
            <g style={{ animation: empty ? "none" : "kingBob 2.8s ease-in-out infinite" }}>
              ...
              <rect x="56" y="97" width="8" height="9" rx="1.5" fill="#B9860B" />

              {/* BAL KAR */}
              <path d="M44 68 c-9 5 -12 16 -10 26 l7 2 c0 -9 2 -17 7 -22 z" fill="#2A5FC4" />
              <circle cx="38" cy="97" r="5" fill="#F2C9A0" />

              {/* FEJ */}
              <circle cx="60" cy="42" r="15" fill="#F5D0A9" />
              <path d="M45 40 a15 15 0 0 1 30 0 z" fill="#5B3A1E" opacity="0.25" />
              <circle cx="54" cy="42" r="1.8" fill="#2B2118" />
              <circle cx="66" cy="42" r="1.8" fill="#2B2118" />
              <circle cx="49" cy="47" r="3" fill="#F19B9B" opacity="0.55" />
              <circle cx="71" cy="47" r="3" fill="#F19B9B" opacity="0.55" />
              {/* száj: iváskor O alakú */}
              {drinking
                ? <ellipse cx="60" cy="51" rx="3.2" ry="3.8" fill="#8A3B3B" />
                : <path d="M54 50 q6 5 12 0" stroke="#8A3B3B" strokeWidth="1.8" fill="none" strokeLinecap="round" />}
              {/* szakáll */}
              <path d="M47 48 q13 22 26 0 q-4 16 -13 17 q-9 -1 -13 -17 z" fill="#fff" opacity="0.92" />
              ...
              <g style={{
                ...
                <path d="M76 68 c10 4 14 14 13 24 l-7 2 c0 -9 -2 -16 -8 -20 z" fill="#2A5FC4" />
        ...
        <div className="min-w-0 flex-1">
          <p className="text-xs font-black uppercase tracking-widest"
            style={{ color: empty ? C.slate : "#FFD466" }}>
            A nap királya
          </p>
          ...
          {empty ? (
            ...
            <>
              ...
              <p className="mt-1 text-sm font-black" style={{ color: "#FFD466" }}>
