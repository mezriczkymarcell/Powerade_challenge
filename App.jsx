...
/* Minden motivációhoz egy részletes, animált SVG jelenet (index 0..14). */
function MotivArt({ i }) {
  const wrap = (children) => (
    <svg viewBox="0 0 320 190" width="100%" height="190" style={{ display: "block" }}>
      <defs>
        <linearGradient id="mSkin" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#FBD9B4" /><stop offset="100%" stopColor="#E9B98A" />
        </linearGradient>
  ...
  const A = {
    // 0 — Pálcikaember NEM tudja átugrani a hatalmas hasat, ezért lihegve megkerüli
    0: wrap(<>
      <ellipse cx="160" cy="176" rx="120" ry="12" fill="#000" opacity="0.06" />
      {/* hatalmas has-ember */}
      <ellipse cx="150" cy="118" rx="70" ry="56" fill="url(#mSkin)" />
      <ellipse cx="150" cy="118" rx="70" ry="56" fill="none" stroke="#D9A473" strokeWidth="2" opacity="0.5" />
      <ellipse cx="150" cy="128" rx="4" ry="7" fill="#C98F5E" opacity="0.6" />
      <circle cx="150" cy="52" r="24" fill="url(#mSkin)" />
      <path d="M128 46 a22 16 0 0 1 44 0 q-22 -8 -44 0z" fill="#5B3A1E" />
      <circle cx="141" cy="52" r="2.6" fill="#2B2118" /><circle cx="159" cy="52" r="2.6" fill="#2B2118" />
      <path d="M142 62 q8 5 16 0" stroke="#B5715A" strokeWidth="2.4" fill="none" strokeLinecap="round" />
      {/* futó pálcikaember, körbejár */}
      <g style={{ transformOrigin: "150px 118px", animation: "orbit 3.4s linear infinite" }}>
        <g transform="translate(238 118)">
          <circle cx="0" cy="-20" r="9" fill="#0F172A" />
          <line x1="0" y1="-11" x2="0" y2="10" stroke="#0F172A" strokeWidth="5" strokeLinecap="round" />
          <g style={{ transformOrigin: "0px 0px", animation: "legRun 0.4s ease-in-out infinite" }}>
            <line x1="0" y1="10" x2="-9" y2="26" stroke="#0F172A" strokeWidth="5" strokeLinecap="round" />
            <line x1="0" y1="10" x2="9" y2="24" stroke="#0F172A" strokeWidth="5" strokeLinecap="round" />
          </g>
          <line x1="0" y1="-4" x2="-12" y2="4" stroke="#0F172A" strokeWidth="4" strokeLinecap="round" />
          <line x1="0" y1="-4" x2="12" y2="2" stroke="#0F172A" strokeWidth="4" strokeLinecap="round" />
        </g>
      </g>
      <style>{`@keyframes orbit{to{transform:rotate(360deg)}}@keyframes legRun{0%,100%{transform:rotate(-16deg)}50%{transform:rotate(16deg)}}`}</style>
    </>),

    // 1 — Sárga daruskocsi, láncon lengő koporsó
    1: wrap(<>
      <ellipse cx="160" cy="178" rx="130" ry="10" fill="#000" opacity="0.06" />
      {/* daru torony + gém */}
      <rect x="40" y="30" width="10" height="120" rx="2" fill="#455A64" />
      <rect x="40" y="30" width="10" height="120" rx="2" fill="url(#mFlame)" opacity="0.08" />
      {[46,66,86,106,126].map(y=><line key={y} x1="40" y1={y} x2="50" y2={y+12} stroke="#263238" strokeWidth="1.5"/>)}
      <line x1="45" y1="30" x2="250" y2="30" stroke="#455A64" strokeWidth="10" strokeLinecap="round" />
      <polygon points="42,30 42,18 60,30" fill="#455A64" />
      <line x1="235" y1="34" x2="235" y2="70" stroke="#90A4AE" strokeWidth="2" />
      {/* lengő koporsó */}
      <g style={{ transformOrigin: "235px 34px", animation: "swingC 2.6s ease-in-out infinite" }}>
        <line x1="235" y1="34" x2="235" y2="72" stroke="#78909C" strokeWidth="2" />
        <polygon points="210,72 260,72 254,120 216,120" fill="#6B4423" />
        <polygon points="210,72 260,72 254,120 216,120" fill="none" stroke="#4E2E14" strokeWidth="2" />
        <rect x="228" y="84" width="14" height="6" rx="1" fill="#C9A227" />
        <rect x="230" y="80" width="10" height="20" rx="2" fill="#C9A227" />
      </g>
      {/* sárga alváz */}
      <rect x="150" y="140" width="120" height="30" rx="5" fill="#F5A623" />
      <rect x="150" y="140" width="120" height="10" rx="5" fill="#fff" opacity="0.25" />
      <rect x="256" y="120" width="34" height="26" rx="4" fill="#F5A623" />
      <rect x="262" y="126" width="22" height="14" rx="2" fill="#7FD3FF" />
      <circle cx="178" cy="172" r="13" fill="#212121" /><circle cx="178" cy="172" r="5" fill="#616161" />
      <circle cx="244" cy="172" r="13" fill="#212121" /><circle cx="244" cy="172" r="5" fill="#616161" />
      <style>{`@keyframes swingC{0%,100%{transform:rotate(-7deg)}50%{transform:rotate(7deg)}}`}</style>
    </>),

    // 2 — Sárgadinnye pulzál a feszülő póló alatt
    2: wrap(<>
      <ellipse cx="160" cy="180" rx="90" ry="9" fill="#000" opacity="0.06" />
      <circle cx="160" cy="46" r="24" fill="url(#mSkin)" />
      <path d="M138 40 a22 16 0 0 1 44 0 q-22 -8 -44 0z" fill="#3E2723" />
      <circle cx="151" cy="46" r="2.6" fill="#2B2118" /><circle cx="169" cy="46" r="2.6" fill="#2B2118" />
      <path d="M150 56 q10 7 20 0" stroke="#B5715A" strokeWidth="2.4" fill="none" strokeLinecap="round" />
      {/* póló */}
      <path d="M120 84 q40 -14 80 0 l12 88 q-52 16 -104 0 z" fill="#2F6FE0" />
      <path d="M120 84 q40 -14 80 0" fill="none" stroke="#1E4FA0" strokeWidth="3" />
      {/* dinnye kidudorodik */}
      <g style={{ transformOrigin: "160px 140px", animation: "melon 1.5s ease-in-out infinite" }}>
        <ellipse cx="160" cy="140" rx="46" ry="40" fill="#8BC34A" />
        <path d="M124 140 q36 -26 72 0" stroke="#558B2F" strokeWidth="3" fill="none" opacity="0.7" />
        <path d="M124 140 q36 26 72 0" stroke="#558B2F" strokeWidth="3" fill="none" opacity="0.7" />
        <path d="M138 108 q22 32 0 64" stroke="#689F38" strokeWidth="2.5" fill="none" opacity="0.6" />
        <path d="M182 108 q-22 32 0 64" stroke="#689F38" strokeWidth="2.5" fill="none" opacity="0.6" />
        <ellipse cx="145" cy="126" rx="10" ry="6" fill="#fff" opacity="0.25" />
      </g>
      <style>{`@keyframes melon{0%,100%{transform:scale(1)}50%{transform:scale(1.07)}}`}</style>
    </>),

    // 3 — Kerítés fölött vigyorgó szomszéd integet
    3: wrap(<>
      <rect x="0" y="150" width="320" height="40" fill="#7CB342" opacity="0.25" />
      {/* kerítéslécek */}
      {Array.from({length:11}).map((_,k)=><rect key={k} x={12+k*28} y="96" width="16" height="80" rx="2" fill="#C8935B"/>)}
      <rect x="6" y="108" width="308" height="10" fill="#A9754A" />
      <rect x="6" y="150" width="308" height="10" fill="#A9754A" />
      {/* szomszéd */}
      <circle cx="235" cy="74" r="26" fill="url(#mSkin)" />
      <path d="M212 66 a24 15 0 0 1 46 0 q-24 -6 -46 0z" fill="#6D4C41" />
      <circle cx="226" cy="72" r="3" fill="#2B2118" /><circle cx="244" cy="72" r="3" fill="#2B2118" />
      <path d="M224 84 q11 8 22 0" stroke="#8A3B3B" strokeWidth="3" fill="none" strokeLinecap="round" />
      <circle cx="219" cy="80" r="4" fill="#F19B9B" opacity="0.5" /><circle cx="251" cy="80" r="4" fill="#F19B9B" opacity="0.5" />
      {/* integető kar */}
      <g style={{ transformOrigin: "262px 92px", animation: "waveH 0.7s ease-in-out infinite" }}>
        <line x1="262" y1="92" x2="286" y2="64" stroke="url(#mSkin)" strokeWidth="9" strokeLinecap="round" />
        <circle cx="288" cy="60" r="7" fill="url(#mSkin)" />
      </g>
      {/* leselkedő "te" a kerítés mögött (csak fejtető) */}
      <path d="M60 108 a22 22 0 0 1 44 0z" fill="url(#mSkin)" />
      <circle cx="74" cy="104" r="2.4" fill="#2B2118" /><circle cx="90" cy="104" r="2.4" fill="#2B2118" />
      <style>{`@keyframes waveH{0%,100%{transform:rotate(-20deg)}50%{transform:rotate(22deg)}}`}</style>
    </>),

    // 4 — Kanapén heverő figura, tv villog
    4: wrap(<>
      <ellipse cx="140" cy="182" rx="130" ry="8" fill="#000" opacity="0.06" />
      {/* kanapé */}
      <rect x="26" y="104" width="180" height="56" rx="14" fill="#8E7CC3" />
      <rect x="18" y="80" width="30" height="80" rx="12" fill="#7E6BB0" />
      <rect x="184" y="80" width="30" height="80" rx="12" fill="#7E6BB0" />
      <rect x="40" y="96" width="150" height="18" rx="8" fill="#9D8DD1" />
      {/* elomló figura */}
      <ellipse cx="120" cy="120" rx="60" ry="20" fill="url(#mSkin)" />
      <circle cx="70" cy="108" r="18" fill="url(#mSkin)" />
      <path d="M56 104 a18 12 0 0 1 34 0z" fill="#5B3A1E" />
      <line x1="62" y1="112" x2="72" y2="112" stroke="#2B2118" strokeWidth="2" strokeLinecap="round" />
      {/* has domb */}
      <ellipse cx="130" cy="112" rx="28" ry="18" fill="#F0B98A" />
      {/* tv */}
      <rect x="238" y="70" width="64" height="44" rx="4" fill="#212121" />
      <rect x="244" y="76" width="52" height="32" fill="#29B6F6" style={{ animation: "tvFlick 0.5s steps(3) infinite" }} />
      <rect x="262" y="114" width="16" height="10" fill="#212121" />
      <rect x="252" y="124" width="36" height="4" rx="2" fill="#212121" />
      <style>{`@keyframes tvFlick{0%{opacity:1}33%{opacity:.55}66%{opacity:.85}}`}</style>
    </>),

    // 5 — Tükör: pici bicepszet mutat, izzadva
    5: wrap(<>
      <ellipse cx="120" cy="182" rx="80" ry="8" fill="#000" opacity="0.06" />
      {/* alak */}
      <ellipse cx="120" cy="128" rx="46" ry="42" fill="url(#mSkin)" />
      <circle cx="120" cy="58" r="24" fill="url(#mSkin)" />
      <path d="M98 52 a22 16 0 0 1 44 0 q-22 -8 -44 0z" fill="#4E342E" />
      <circle cx="111" cy="58" r="2.6" fill="#2B2118" /><circle cx="129" cy="58" r="2.6" fill="#2B2118" />
      <path d="M112 68 q8 4 16 0" stroke="#8A3B3B" strokeWidth="2.4" fill="none" strokeLinecap="round" />
      {/* felemelt kar, pici bicepsz */}
      <g style={{ transformOrigin: "150px 116px", animation: "flexArm 1.3s ease-in-out infinite" }}>
        <path d="M150 116 q26 -8 30 -30 q-10 -4 -18 8 q-6 8 -14 14z" fill="url(#mSkin)" />
        <circle cx="166" cy="92" r="7" fill="#F0B98A" />
      </g>
      {/* izzadságcseppek */}
      {[[100,44],[142,46]].map(([cx,cy],k)=>(
        <circle key={k} cx={cx} cy={cy} r="3" fill="#4FC3F7"
          style={{ animation:`sweat 1.4s ease-out ${k*0.5}s infinite` }} />
      ))}
      {/* tükörkeret */}
      <rect x="210" y="40" width="90" height="120" rx="8" fill="none" stroke="#B0BEC5" strokeWidth="6" />
      <rect x="216" y="46" width="78" height="108" rx="4" fill="#E3F2FD" opacity="0.5" />
      <line x1="224" y1="54" x2="240" y2="70" stroke="#fff" strokeWidth="4" opacity="0.7" />
      <style>{`@keyframes flexArm{0%,100%{transform:rotate(0)}50%{transform:rotate(-8deg)}}@keyframes sweat{0%{opacity:0;transform:translateY(0)}30%{opacity:1}100%{opacity:0;transform:translateY(20px)}}`}</style>
    </>),

    // 6 — Nagy dobogó szív + EKG vonal
    6: wrap(<>
      <rect x="0" y="92" width="320" height="3" fill="#CFD8DC" />
      <polyline points="0,93 90,93 108,60 124,126 140,40 158,120 176,93 320,93"
        fill="none" stroke="#E53935" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round"
        style={{ strokeDasharray: 700, animation: "ekg 2.2s linear infinite" }} />
      <g style={{ transformOrigin: "230px 96px", animation: "beat 0.75s ease-in-out infinite" }}>
        <path d="M230 150 C188 118 190 74 214 66 C230 60 244 72 230 88 C216 72 230 60 246 66 C270 74 272 118 230 150 Z" fill="#E53935" />
        <path d="M214 82 q10 -8 20 -2" stroke="#fff" strokeWidth="4" fill="none" strokeLinecap="round" opacity="0.7" />
      </g>
      <style>{`@keyframes beat{0%,100%{transform:scale(1)}25%{transform:scale(1.14)}40%{transform:scale(1)}}@keyframes ekg{from{stroke-dashoffset:700}to{stroke-dashoffset:0}}`}</style>
    </>),

    // 7 — Fekete teherautó "HALÁL" felirattal, guruló kerekek, füst
    7: wrap(<>
      <line x1="0" y1="164" x2="320" y2="164" stroke="#B0BEC5" strokeWidth="3" strokeDasharray="18 12"
        style={{ animation: "road 0.6s linear infinite" }} />
      <g style={{ animation: "truck 3.2s ease-in-out infinite" }}>
        <rect x="60" y="86" width="140" height="60" rx="6" fill="#263238" />
        <rect x="200" y="104" width="52" height="42" rx="6" fill="#37474F" />
        <rect x="208" y="110" width="34" height="20" rx="3" fill="#7FD3FF" opacity="0.8" />
        <text x="130" y="126" textAnchor="middle" fontSize="26" fontWeight="900" fill="#fff" letterSpacing="2">HALÁL</text>
        <circle cx="96" cy="152" r="15" fill="#111" />
        <circle cx="96" cy="152" r="6" fill="#555" style={{ transformOrigin:"96px 152px", animation:"wheel 0.5s linear infinite" }} />
        <circle cx="224" cy="152" r="15" fill="#111" />
        <circle cx="224" cy="152" r="6" fill="#555" style={{ transformOrigin:"224px 152px", animation:"wheel 0.5s linear infinite" }} />
      </g>
      {[0,1,2].map(k=>(
        <circle key={k} cx={54-k*14} cy={100-k*4} r={6+k*2} fill="#90A4AE"
          style={{ animation:`smoke 1.6s ease-out ${k*0.3}s infinite` }} />
      ))}
      <style>{`@keyframes truck{0%,100%{transform:translateX(-14px)}50%{transform:translateX(14px)}}@keyframes wheel{to{transform:rotate(360deg)}}@keyframes road{to{transform:translateX(-30px)}}@keyframes smoke{0%{opacity:.6;transform:translate(0,0) scale(.6)}100%{opacity:0;transform:translate(-20px,-14px) scale(1.4)}}`}</style>
    </>),

    // 8 — Síró futó, könnycseppek, mozgásvonalak
    8: wrap(<>
      <ellipse cx="160" cy="180" rx="90" ry="8" fill="#000" opacity="0.06" />
      <g style={{ transformOrigin: "160px 120px", animation: "bobRun 0.5s ease-in-out infinite" }}>
        <circle cx="168" cy="52" r="22" fill="url(#mSkin)" />
        <path d="M148 46 a20 14 0 0 1 40 0 q-20 -6 -40 0z" fill="#4E342E" />
        <circle cx="162" cy="52" r="2.6" fill="#2B2118" /><circle cx="176" cy="52" r="2.6" fill="#2B2118" />
        <path d="M160 62 q9 8 18 2" stroke="#8A3B3B" strokeWidth="2.4" fill="none" strokeLinecap="round" />
        {/* test */}
        <path d="M150 74 q18 -8 36 0 l-4 40 -28 0z" fill="#2F6FE0" />
        {/* karok */}
        <line x1="152" y1="86" x2="132" y2="104" stroke="url(#mSkin)" strokeWidth="8" strokeLinecap="round" />
        <line x1="184" y1="86" x2="202" y2="70" stroke="url(#mSkin)" strokeWidth="8" strokeLinecap="round" />
        {/* lábak */}
        <g style={{ transformOrigin:"166px 114px", animation:"legs 0.5s ease-in-out infinite" }}>
          <line x1="160" y1="114" x2="142" y2="150" stroke="#1E293B" strokeWidth="9" strokeLinecap="round" />
        </g>
        <line x1="172" y1="114" x2="192" y2="148" stroke="#1E293B" strokeWidth="9" strokeLinecap="round" />
      </g>
      {[[156,62],[180,62]].map(([cx,cy],k)=>(
        <circle key={k} cx={cx} cy={cy} r="3.4" fill="#4FC3F7"
          style={{ animation:`cry 1s ease-in ${k*0.35}s infinite` }} />
      ))}
      {[70,88,106].map((y,k)=>(
        <line key={y} x1="70" y1={y} x2={110-k*8} y2={y} stroke="#B0BEC5" strokeWidth="3" strokeLinecap="round"
          style={{ animation:`speed 0.6s linear ${k*0.1}s infinite` }} />
      ))}
      <style>{`@keyframes bobRun{0%,100%{transform:rotate(-3deg)}50%{transform:rotate(3deg)}}@keyframes legs{0%,100%{transform:rotate(-18deg)}50%{transform:rotate(18deg)}}@keyframes cry{0%{opacity:1;transform:translateY(0)}100%{opacity:0;transform:translateY(24px)}}@keyframes speed{0%{opacity:0;transform:translateX(10px)}50%{opacity:1}100%{opacity:0;transform:translateX(-10px)}}`}</style>
    </>),

    // 9 — Omladozó, elhagyatott laktanya, hulló téglák
    9: wrap(<>
      <rect x="0" y="164" width="320" height="26" fill="#8D6E63" opacity="0.2" />
      <rect x="70" y="60" width="180" height="106" fill="#9E9E9E" />
      <rect x="70" y="60" width="180" height="106" fill="none" stroke="#616161" strokeWidth="2" />
      {/* téglasorok */}
      {Array.from({length:5}).map((_,r)=>Array.from({length:8}).map((_,c)=>(
        <rect key={`${r}-${c}`} x={78+c*20} y={70+r*18} width="16" height="13" rx="1" fill="#78909C"
          style={{ animation:`fall 2.4s ease-in ${(r*8+c)%9*0.18}s infinite`, transformOrigin:"center" }} />
      )))}
      {/* törött ablakok */}
      <rect x="96" y="120" width="24" height="30" fill="#37474F" />
      <line x1="96" y1="120" x2="120" y2="150" stroke="#90A4AE" strokeWidth="1.5" />
      <rect x="200" y="120" width="24" height="30" fill="#37474F" />
      <line x1="224" y1="120" x2="200" y2="150" stroke="#90A4AE" strokeWidth="1.5" />
      {/* rogyadozó tető */}
      <polygon points="66,60 160,32 254,60" fill="#6D4C41" />
      <polygon points="120,45 160,32 175,38" fill="#5D4037" opacity="0.7" />
      {/* csillag a homlokzaton (szovjet utalás) */}
      <path d="M160 90 l4 10 11 0 -9 7 4 11 -10 -7 -10 7 4 -11 -9 -7 11 0z" fill="#C62828" opacity="0.55" />
      <style>{`@keyframes fall{0%,70%{opacity:1;transform:translateY(0)}85%{opacity:.4;transform:translateY(6px) rotate(6deg)}100%{opacity:1;transform:translateY(0)}}`}</style>
    </>),

    // 10 — Koleszterin-görbe kilő fölfelé, LDL zászló
    10: wrap(<>
      <line x1="36" y1="160" x2="300" y2="160" stroke="#90A4AE" strokeWidth="3" />
      <line x1="36" y1="160" x2="36" y2="30" stroke="#90A4AE" strokeWidth="3" />
      {[130,100,70,40].map((y,k)=><line key={y} x1="33" y1={y} x2="39" y2={y} stroke="#90A4AE" strokeWidth="2"/>)}
      <polyline points="36,150 96,138 150,108 206,64 288,26"
        fill="none" stroke="#E53935" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round"
        style={{ strokeDasharray: 340, animation: "climb 2.4s ease-out infinite" }} />
      {[[96,138],[150,108],[206,64],[288,26]].map(([cx,cy],k)=>(
        <circle key={k} cx={cx} cy={cy} r="4.5" fill="#fff" stroke="#E53935" strokeWidth="3"/>
      ))}
      <g style={{ transformOrigin:"288px 26px", animation:"flag 1.6s ease-in-out infinite" }}>
        <line x1="288" y1="26" x2="288" y2="6" stroke="#455A64" strokeWidth="2" />
        <path d="M288 6 l22 5 -22 6z" fill="#E53935" />
        <text x="300" y="34" fontSize="13" fontWeight="900" fill="#E53935">LDL ↑</text>
      </g>
      <style>{`@keyframes climb{from{stroke-dashoffset:340}to{stroke-dashoffset:0}}@keyframes flag{0%,100%{transform:rotate(0)}50%{transform:rotate(-6deg)}}`}</style>
    </>),

    // 11 — Kifogás-buborékok felszállnak és elpukkannak
    11: wrap(<>
      <ellipse cx="160" cy="182" rx="90" ry="8" fill="#000" opacity="0.06" />
      {/* pihenő figura lent */}
      <ellipse cx="160" cy="164" rx="40" ry="16" fill="url(#mSkin)" />
      <circle cx="132" cy="150" r="14" fill="url(#mSkin)" />
      {[["most nincs időm",84,54,0],["majd holnap",176,44,0.6],["fáj a térdem",250,70,1.2]].map(([t,x,y,d],k)=>(
        <g key={k} style={{ transformOrigin:`${x}px ${y}px`, animation:`rise 2.6s ease-in-out ${d}s infinite` }}>
          <ellipse cx={x} cy={y} rx="52" ry="26" fill="#fff" stroke="#CBD5E1" strokeWidth="2" />
          <ellipse cx={x-30} cy={y+22} rx="7" ry="5" fill="#fff" stroke="#CBD5E1" strokeWidth="2" />
          <text x={x} y={y+4} textAnchor="middle" fontSize="12" fontWeight="700" fill="#64748B">{t}</text>
        </g>
      ))}
      <style>{`@keyframes rise{0%{opacity:0;transform:translateY(14px) scale(.9)}25%{opacity:1;transform:translateY(0) scale(1)}70%{opacity:1}85%{opacity:0;transform:scale(1.25)}100%{opacity:0}}`}</style>
    </>),

    // 12 — GPS képernyő "Újratervezés", pörgő iránytű, pislákoló útvonal
    12: wrap(<>
      <rect x="86" y="26" width="148" height="140" rx="16" fill="#1B2430" />
      <rect x="86" y="26" width="148" height="140" rx="16" fill="none" stroke="#334155" strokeWidth="3" />
      {/* térkép vonalak */}
      {[50,74,98,122].map(y=><line key={y} x1="96" y1={y} x2="224" y2={y} stroke="#2E3B4E" strokeWidth="2"/>)}
      {[120,150,180,210].map(x=><line key={x} x1={x} y1="40" x2={x} y2="130" stroke="#2E3B4E" strokeWidth="2"/>)}
      {/* villódzó útvonal */}
      <polyline points="110,130 130,96 170,96 170,54 210,54" fill="none" stroke="#3BC9DB" strokeWidth="4"
        strokeLinecap="round" strokeLinejoin="round" style={{ animation:"blink 0.8s steps(2) infinite" }} />
      {/* pörgő iránytű */}
      <g style={{ transformOrigin: "160px 88px", animation: "spinC 2s linear infinite" }}>
        <circle cx="160" cy="88" r="18" fill="#0F172A" stroke="#3BC9DB" strokeWidth="2" />
        <polygon points="160,74 166,90 160,86 154,90" fill="#E53935" />
        <polygon points="160,102 166,86 160,90 154,86" fill="#ECEFF1" />
      </g>
      <rect x="96" y="140" width="128" height="20" rx="6" fill="#0F172A" />
      <text x="160" y="154" textAnchor="middle" fontSize="12" fontWeight="900" fill="#FF5252">Újratervezés…</text>
      <style>{`@keyframes spinC{to{transform:rotate(360deg)}}@keyframes blink{0%{opacity:1}50%{opacity:.3}}`}</style>
    </>),

    // 13 — Önbecsülés-tartály lassan lecsorog
    13: wrap(<>
      <text x="160" y="30" textAnchor="middle" fontSize="13" fontWeight="900" fill="#64748B">ÖNBECSÜLÉS</text>
      {/* mérce keret */}
      <rect x="128" y="40" width="64" height="128" rx="32" fill="#ECEFF1" stroke="#B0BEC5" strokeWidth="4" />
      {/* folyadék */}
      <clipPath id="tank"><rect x="132" y="44" width="56" height="120" rx="28" /></clipPath>
      <g clipPath="url(#tank)">
        <rect x="132" y="120" width="56" height="60" fill="#2F6FE0"
          style={{ animation: "drain 3s ease-in-out infinite" }} />
        <rect x="132" y="120" width="56" height="8" fill="#5B8DEF"
          style={{ animation: "drain 3s ease-in-out infinite" }} />
      </g>
      {/* skála */}
      {[60,90,120,150].map(y=><line key={y} x1="192" y1={y} x2="204" y2={y} stroke="#90A4AE" strokeWidth="2"/>)}
      {/* csöpög */}
      <circle cx="160" cy="172" r="4" fill="#2F6FE0" style={{ animation:"drip 1.4s ease-in infinite" }} />
      <style>{`@keyframes drain{0%{transform:translateY(0)}50%{transform:translateY(46px)}100%{transform:translateY(0)}}@keyframes drip{0%{opacity:0;transform:translateY(0)}30%{opacity:1}100%{opacity:0;transform:translateY(16px)}}`}</style>
    </>),

    // 14 — Kanapé, körülötte pulzáló "gravitációs mező", figura beleszív
    14: wrap(<>
      <ellipse cx="160" cy="150" rx="110" ry="30" fill="#B39DDB" opacity="0.35"
        style={{ transformOrigin:"160px 150px", animation:"grav 2s ease-in-out infinite" }} />
      <ellipse cx="160" cy="150" rx="80" ry="20" fill="#9575CD" opacity="0.35"
        style={{ transformOrigin:"160px 150px", animation:"grav 2s ease-in-out 0.3s infinite" }} />
      {/* kanapé */}
      <rect x="76" y="118" width="168" height="48" rx="14" fill="#8E7CC3" />
      <rect x="68" y="98" width="26" height="68" rx="10" fill="#7E6BB0" />
      <rect x="226" y="98" width="26" height="68" rx="10" fill="#7E6BB0" />
      {/* elomló figura */}
      <ellipse cx="160" cy="128" rx="56" ry="18" fill="url(#mSkin)" />
      <circle cx="112" cy="116" r="16" fill="url(#mSkin)" />
      <path d="M100 110 a16 11 0 0 1 30 0z" fill="#4E342E" />
      <line x1="106" y1="118" x2="118" y2="118" stroke="#2B2118" strokeWidth="2" strokeLinecap="round" />
      <ellipse cx="176" cy="122" rx="24" ry="14" fill="#F0B98A" />
      {/* lefelé mutató nyilak */}
      {[120,160,200].map((x,k)=>(
        <g key={x} style={{ animation:`pull 1.4s ease-in ${k*0.2}s infinite` }}>
          <line x1={x} y1="44" x2={x} y2="72" stroke="#7E57C2" strokeWidth="3" strokeLinecap="round" />
          <polygon points={`${x-5},68 ${x+5},68 ${x},78`} fill="#7E57C2" />
        </g>
      ))}
      <style>{`@keyframes grav{0%,100%{transform:scale(1);opacity:.35}50%{transform:scale(1.12);opacity:.5}}@keyframes pull{0%{opacity:0;transform:translateY(-8px)}50%{opacity:1}100%{opacity:0;transform:translateY(8px)}}`}</style>
    </>),
  };
  return A[i] || A[0];
}
