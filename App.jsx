...
const MOTIVATIONS = [
  "Könnyebb téged megkerülni, mint átugrani. Mozogj már!",
  "Ha így folytatod, a koporsódat nem hordárok, hanem egy darus kocsi fogja vinni.",
  "A sörhas nem tekintély, hanem egy lassan ölő sárgadinnye a pólód alatt. Emeld fel a segged!",
  "Fuss egy kört! A párodnak is kell egy kis egyedüllét a szomszéddal.",
  "A zsírod nem melegít, csak eltakarja azt a minimális férfiasságodat, ami még megmaradt.",
  "Ha ma sem edzel, holnapra megint egy lépéssel közelebb kerülsz az infarktushoz. Egészségedre!",
  "A halál mindannyiunkért eljön, de érted valószínűleg teherszállítóval kell jönnie.",
  "Sírva is lehet futni, ráadásul a könnyekkel is vizet veszítesz. Nyomás!",
  "A tested egy templom. De jelenleg inkább egy omladozó, elhagyatott szovjet laktanyára hasonlít.",
  "Az egyetlen dolog, ami gyorsabban nő benned a motivációnál, az a koleszterinszinted.",
  "A kifogások nem égetnek kalóriát. Indulás!",
  "Még a GPS is azt mondja rád, hogy „újratervezés”, amikor meglátja a sziluettedet.",
  "Ha most elindulsz futni, talán még azelőtt hazaérsz, hogy teljesen elhagynád az önbecsülésed.",
  "Nem vagy te lusta, csak a saját gravitációs meződ tart fogva a kanapén. Törj ki belőle!",
  "Fuss el a problémáid elől. Vagy legalább a korai szívhalál elől.",
];
