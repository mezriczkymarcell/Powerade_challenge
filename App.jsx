...
function MotivArt({ i }) {
  ...
  const A = {
    ...
    /* 14 — kanapén OLDALT, összekuporodva heverő figura; gravitációs mező + nyilak */
    14: wrap(
      <>
      ...
      <>
        <ellipse cx="160" cy="150" rx="118" ry="34" fill="url(#fieldG)"
          style={{ transformOrigin: "160px 150px", animation: "m14grav 2.2s ease-in-out infinite" }} />
        {[120, 160, 200].map((x, k) => (
          <g key={x} style={{ animation: `m14pull 1.5s ease-in ${k * 0.2}s infinite` }}>
            <line x1={x} y1="34" x2={x} y2="64" stroke="#7E57C2" strokeWidth="3.5" strokeLinecap="round" />
            <polygon points={`${x - 6},60 ${x + 6},60 ${x},72`} fill="#7E57C2" />
          </g>
        ))}
        {/* kanapé */}
        <rect x="64" y="132" width="192" height="44" rx="14" fill="url(#couch2)" filter="url(#soft)" />
        <rect x="56" y="96" width="30" height="80" rx="12" fill="#8877C2" />
        <rect x="234" y="96" width="30" height="80" rx="12" fill="#8877C2" />
        <rect x="86" y="120" width="148" height="20" rx="9" fill="#A99AD8" />
        {/* összekuporodó alak */}
        <g filter="url(#soft)">
          <g transform="translate(96 116)">
            <circle cx="0" cy="0" r="17" fill="url(#skin)" />
            <circle cx="0" cy="0" r="17" fill="url(#skinHi)" />
            <path d="M-17 0 a17 17 0 0 1 26 -13 q-8 -3 -16 0 q-9 4 -10 13z" fill="#3E2723" />
            <path d="M6 -13 q9 3 8 12 q-4 -7 -11 -8z" fill="#3E2723" />
            <ellipse cx="1" cy="2" rx="3.5" ry="4.5" fill="#EBB884" />
            <path d="M-11 0 q4 -3 8 0" stroke="#2B2118" strokeWidth="1.7" fill="none" strokeLinecap="round" />
            <path d="M-16 3 q-4 2 -1 5 l4 -1z" fill="#EBB884" />
            <path d="M-12 10 q4 2 8 0" stroke="#8A3B3B" strokeWidth="1.8" fill="none" strokeLinecap="round" />
            <circle cx="-6" cy="7" r="3" fill="#F19B9B" opacity="0.4" />
          </g>
          {/* felhúzott térd, pulóver */}
          <path d="M118 132 q28 -14 58 -8 q22 4 30 22 q6 12 -4 20 q-10 8 -24 4 q-30 -8 -56 -12 q-16 -3 -4 -26z" fill="url(#hoodie)" />
          <path d="M150 128 q26 0 42 16" stroke="#1B5E20" strokeWidth="2.5" fill="none" opacity="0.5" />
          {/* visszahajló lábszár */}
          <path d="M198 150 q14 8 8 22 q-2 6 -8 4 q-6 -2 -6 -10 q0 -10 6 -16z" fill="#37474F" />
          <ellipse cx="200" cy="172" rx="10" ry="6" fill="#263238" />
          {/* összefont kar a térden */}
          <path d="M120 136 q22 -6 40 4 q6 3 3 9 q-3 5 -9 3 q-18 -8 -36 -6 q-8 1 -8 -5 q0 -6 10 -9z" fill="url(#skin)" />
          <ellipse cx="158" cy="146" rx="7" ry="6" fill="#EBB884" />
        </g>
        <style>{`@keyframes m14grav{0%,100%{transform:scale(1);opacity:.9}50%{transform:scale(1.12);opacity:1}}@keyframes m14pull{0%{opacity:0;transform:translateY(-8px)}50%{opacity:1}100%{opacity:0;transform:translateY(10px)}}`}</style>
      </>),
