...
/* ============================ FUTÓSZALAG ================================= */
const Ticker = () => {
  const msg = "Ne felejtsd el bevenni a vitaminjaidat 💊";
  ...
  return (
    <div className="relative overflow-hidden" style={{ background: C.ink }}>
      ...
      `}</style>
      <div className="flex w-max whitespace-nowrap py-1.5"
        style={{ animation: "pcMarquee 34s linear infinite" }}>
        {/* kétszer egymás után, hogy zökkenőmentes legyen a hurok */}
        {[0, 1].map((half) => (
          <div key={half} className="flex">
            {items.map((_, i) => (
              <span key={i} className="mx-6 text-xs font-bold tracking-wide"
                style={{ color: "#E2E8F0" }}>
                {msg}
              </span>
            ))}
...
/* ============================ VITAMIN SZALAG ============================= */
const Ticker = () => {
  const text = "Ne felejtsd el bevenni a vitaminjaidat 💊";
    ...
    <div className="w-full overflow-hidden" style={{ background: C.ink }}>
      ...
      <div className="flex whitespace-nowrap py-1.5"
        ...
        {[0, 1].map((half) => (
          <div key={half} className="flex">
            {items.map((_, i) => (
              <span key={i} className="flex items-center gap-2 px-6 text-xs font-bold tracking-wide"
                style={{ color: "#E2E8F0" }}>
                {text}
